  ...
  return (
    <div className="w-[300px]">
      <div className="flex justify-between mb-3">
        ...
        <a href="#" className="text-sky-900 text-sm">
          Reset
        </a>
      </div>
      <div className="flex justify-between items-center mb-3">
        <label className="flex items-center space-x-2">
          ...
          />
          <label htmlFor="allCategories" className="ml-0 text-gray-800">
            All Categories
          </label>
        </label>
      ...
      {CATEGORIES.map((category, index) => (
        <div key={index} className="flex justify-between items-center mb-3">
          <label className="flex items-center space-x-2">
            ...
            />
            <label htmlFor={category.name} className="ml-0 text-gray-800">
              {category.name}
            </label>
          </label>
      ...
      <div className="flex justify-between items-center mb-3">
        <label className="flex items-center space-x-2">
          ...
          />
          <label htmlFor="other" className="ml-0 text-gray-800">
            other
          </label>
        </label>
        <div className="text-sky-900">5</div>
