      ...
      <div className="min-h-full flex flex-col lg:flex-row py-14">
        ...
        <div className="w-full lg:w-[50%] h-full lg:h-auto lg:flex lg:ml-5">
          <div className="w-[500px] h-full lg:h-auto lg:w-full flex-col gap-2 flex mt-10 lg:mt-0 m-auto">
            ...
            <div className="text-zinc-600 text-base font-small">
            ...
            <div className="flex items-center">
              ...
              <div className="flex gap-2 ml-3">
                <button className="w-16 h-8 bg-zinc-100 border items-center justify-center fle focus:bg-blue-200">
                  30
                </button>
                <button className="w-16 h-8 bg-zinc-100 border items-center justify-center fle focus:bg-blue-200">
                  56
            ...
            <div className="flex items-center">
              ...
              <div className="flex gap-0 ml-3">
                <button className="w-10 h-8 bg-zinc-100 border items-center justify-center flex">
                  -
                </button>
                <input
                  type="text"
                  className="w-14 h-8 bg-zinc-100 border border-slate-200 focus:ring-0 focus:border-slate-200"
                />
                <button className="w-10 h-8 bg-zinc-100 border items-center justify-center flex">
                  +
                </button>
            ...
            <div className="flex gap-3 mt-3">
              <button className="w-56 h-16 bg-amber-500 text-white text-lg font-medium rounded-full ">
                Add to cart
              </button>
              <button className="w-56 h-16 bg-amber-500 text-white text-lg font-medium rounded-full ">
                Buy it now
              ...
              <button className="w-16 h-16 bg-zinc-100 rounded-full justify-center items-center flex hover:bg-amber-600 group">
                <div className="w-9 h-9 justify-center items-center flex">
                  <div className="w-9 h-9 relative">
                    <svg
                      className="group-hover:stroke-white stroke-slate-600"
                      width="36"
                      height="36"
                      viewBox="0 0 15 16"
                      fill="none"
